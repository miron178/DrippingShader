Shader "Roystan/Grass"
{
    Properties
    {
		...
		_TessellationNearDist("Tessellation Near Distance", Float) = 10
		_TessellationFarDist("Tessellation Far Distance"  , Float) = 30
	...
	float _TessellationNearDist;
	float _TessellationFarDist;

	TessellationFactors patchConstantFunction(InputPatch<vertexInput, 3> patch)
	{
		float4 tess = UnityDistanceBasedTess(patch[0].vertex, patch[1].vertex, patch[2].vertex, 
			_TessellationNearDist, _TessellationFarDist, _TessellationUniform);
